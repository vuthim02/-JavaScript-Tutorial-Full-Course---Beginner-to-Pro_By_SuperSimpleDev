...
| 11 | [11-property-descriptors.md](11-property-descriptors.md) | writable, enumerable, configurable, defineProperty, getters/setters |
| 12 | [12-freeze-seal.md](12-freeze-seal.md) | Object.freeze, Object.seal, Object.preventExtensions, comparison |
| 13 | [13-optional-chaining-nullish.md](13-optional-chaining-nullish.md) | Optional chaining (?.), nullish coalescing (??), vs || |
| 14 | [14-bigint.md](14-bigint.md) | BigInt, large integers, operations, mixing with Number |
| 15 | [15-regexp.md](15-regexp.md) | Regular expressions, patterns, flags, groups, lookahead/lookbehind |
| 16 | [16-tagged-templates.md](16-tagged-templates.md) | Tagged template literals, safe HTML, CSS-in-JS |
| 17 | [17-intl.md](17-intl.md) | Intl API, number/date formatting, relative time, collation |
| 18 | [18-proxy.md](18-proxy.md) | Proxy traps (get, set, has, deleteProperty, apply, construct), revocable |
| 19 | [19-reflect.md](19-reflect.md) | Reflect API, default behavior in Proxy handlers, Reflect.ownKeys |
| 20 | [20-metaprogramming.md](20-metaprogramming.md) | Meta-programming patterns, Proxy, descriptors, framework usage |
| 21 | [21-memory-behavior.md](21-memory-behavior.md) | Heap vs stack, GC, closures, memory leaks, detection |
| 22 | [22-es2022-es2023.md](22-es2022-es2023.md) | ES2022: Array.at(), Object.hasOwn(), Error.cause, class fields, top-level await; ES2023: findLast, hashbang, Symbol WeakMap keys |
| 23 | [23-es2024.md](23-es2024.md) | ES2024: Promise.withResolvers(), Object.groupBy, Atomics.waitAsync, RegExp v flag; Summary table |
| 24 | [24-reveng-checklist.md](24-reveng-checklist.md) | Senior reverse engineering checklist, Part 10 summary table |
